...
public class EchoProtocol implements AsyncServerProtocol<StringMessage> {
	...
	public StringMessage processMessage(StringMessage clientMsg,Client client) {  
		...
		if (msg != null) {//for every message sending to the right method to process it 
			...
			// 14
			else if (msg.startsWith(Configuration.getTypes)){ans = handle_getTypes(msg,client);}
			// 15
			...
			// 16.5
			else if (msg.startsWith(Configuration.deleteType)){ans =handle_deleteType(msg,client);}
			// 17
			...
			// 18.5 1/5
			else if (msg.startsWith(Configuration.getAllAdminsInForum)){ans = handle_getAllAdminsInForum(msg,client);}
			// 18.5 2/5
			else if (msg.startsWith(Configuration.getMyPosts)){ans = handle_getMyPosts(msg, client);}
			// 18.5 3/5
			else if (msg.startsWith(Configuration.getMyFreinds)){ans = handle_getMyFreinds(msg, client);}
			// 18.5 4/5
			else if (msg.startsWith(Configuration.getMyRequests)){ans = handle_getMyRequests(msg, client);}
			// 18.5 5/5
			else if (msg.startsWith(Configuration.getJoinedMemberInForums)){ans = handle_getJoinedMemberInForums(msg, client);}
			//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			////////////// SUBFORUM //////////////////////////////////////////////////////////////////////////////////////////////////////////
			//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			// 19
			...
			// 30.5
			else if (msg.startsWith(Configuration.getAllModerators)){ans =handle_getAllModerators(msg,client);}

			///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			////////////// THREAD //////////////////////////////////////////////////////////////////////////////////////////////////////////
			//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			// 31
			else if (msg.startsWith(Configuration.getThreadContent)){ans =handle_getThreadContent(msg,client);}
			// 32
			...
			// 35.5
			else if (msg.startsWith(Configuration.isItMyPost)){ans =handle_isItMyPost(msg,client);}
			///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			////////////// RESPONSE //////////////////////////////////////////////////////////////////////////////////////////////////////////
			//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			// 36
			...
			// 39.5
			else if (msg.startsWith(Configuration.isItMyResponse)){ans =handle_isItMyResponse(msg,client);}
			///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			////////////// MEMBERS //////////////////////////////////////////////////////////////////////////////////////////////////////////
			//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			// 40
			...
			else if (msg.startsWith(Configuration.exit)){ans=handle_exit(msg,client);}
			
			else if (msg.startsWith(Configuration.getNotifications)){ans=handle_getNotifications(msg,client);}
			else if (msg.startsWith(Configuration.sendFriendRequest)){ans=handle_sendFriendRequest(msg,client);}
	...
	// <Conf.sendFriendRequest> <DELIM1> <requesterName> <DELIM1> <sendTo> <DELIM1> <forumName>
		private String handle_sendFriendRequest(String msg, Client client) {
			String[] parsedMsg =  msg.split(Configuration.DELIMITER1);
			if (parsedMsg.length != 4){
				System.out.println("Got a sendFriendReq, but not with 3 param");
				return Configuration.FAIL;
			}

			String requesterName=parsedMsg[1];
			String sendTo=parsedMsg[2];
			String forumName=parsedMsg[3].substring(0, parsedMsg[3].length()-1);

			boolean ans = this.serverHandler.sendFriendRequest(requesterName, sendTo, forumName);
			if (ans)
				return Configuration.SUCCESS + " " + Configuration.DELIMITER1 + " " + "friend request sent!";
			return Configuration.FAIL + " " + Configuration.DELIMITER1 + " " + "The friend request wasnt sent!";
	...
	private String handle_numOfForumsReport(String msg, Client client) {
		...
		return Configuration.SUCCESS + " " + Configuration.DELIMITER1 + " " + "The number of forums in the system is "+num+" ." ;
	}
	...
	private String handle_createForum(String msg, Client client) {
		String[] parsedMsg =  msg.split(Configuration.DELIMITER1);
		if (parsedMsg.length != 11){
			System.out.println("Got a createForum, but not with 10 params");
			return Configuration.FAIL;
		}
		...
		if (ans)
			return Configuration.SUCCESS + " " + Configuration.DELIMITER1 + " " +forumName+" forum created successfully";
		return Configuration.FAIL + " " + Configuration.DELIMITER1 + " " + "Failed to create "+forumName+" forum";
	}
	...
	private String handle_deleteForum(String msg, Client client) {
		...
		if(ans)
			return Configuration.SUCCESS + " " + "Deleted the forum " + forumName + " successfully.";
		return Configuration.FAIL + " " + "Failed to delete the forum" + forumName;
	}
	...
	private String handle_logout(String msg, Client client) {
		...
		if (ans)
			return Configuration.SUCCESS + " " + Configuration.DELIMITER1 + " " + userName+" logged out successfully.";
		return Configuration.FAIL + " " + Configuration.DELIMITER1 + " " + "The logout failed.\nPlease try again..";
	}
	...
	private String handle_removeAdminFromForum(String msg, Client client) {
		...
		if (ans)
			return Configuration.SUCCESS + " " + Configuration.DELIMITER1 + " " + adminName+" removed from administration successfully.";
		return Configuration.FAIL + " " + Configuration.DELIMITER1 + " " + "Failed to remove administrator.";
	}

	// 7
	// <Conf.validateByEmail> <DELIM1> <userName> <DELIM1> <forumname> <DELIM1><code>
	private String handle_validateByEmail(String msg, Client client) {
		String[] parsedMsg =  msg.split(Configuration.DELIMITER1);
		if (parsedMsg.length != 4){
			System.out.println("Got a validateByEmail, but not with 3 params");
			return Configuration.FAIL;
		}
		...
		if (ans)
			return Configuration.SUCCESS + " " + Configuration.DELIMITER1 + " " + userName+" validated successfully.";
		return Configuration.FAIL + " " + Configuration.DELIMITER1 + " " + "Code does not match.";
	}
	...
	private String handle_banMember(String msg, Client client) {
		...
		if (ans)
			return Configuration.SUCCESS + " " + Configuration.DELIMITER1 + " user " + memberToBanName+" is successfully banned.";
		return Configuration.FAIL + " " + Configuration.DELIMITER1 + " " + "Failed to ban "+memberToBanName+" .";
	}
	...
	// 14
	// <Conf.getTypes> <DELIM1> <forumName>
	public String handle_getTypes(String msg, Client client){
		String[] parsedMsg =  msg.split(Configuration.DELIMITER1);
		if (parsedMsg.length != 2){
			System.out.println("Got a getTypes, but not with 1 param");
			return Configuration.FAIL;
		}

		String forumName = parsedMsg[1].substring(0, parsedMsg[1].length()-1);

		Vector<String> types = this.serverHandler.getTypes(forumName);
		String ans = "";

		if (types != null)
			for (String type: types)
				ans += type + Configuration.DELIMITER1;
	...
	// 16.5
	// <Conf.deleteType> <DELIM1> <forumName> <DELIM1> <type>
	private String handle_deleteType(String msg, Client client) {
		String[] parsedMsg =  msg.split(Configuration.DELIMITER1);
		if (parsedMsg.length != 3){
			System.out.println("Got a createType, but not with 2 params");
			return Configuration.FAIL;
		}

		String forumName = parsedMsg[1];
		String type = parsedMsg[2].substring(0, parsedMsg[3].length()-1); 

		boolean ans = this.serverHandler.deleteType(forumName, type);
		if (ans)
			return Configuration.SUCCESS + " " + Configuration.DELIMITER1+ " " + type + " type has added seccessfuly.";
		return Configuration.FAIL+ " " + Configuration.DELIMITER1 + " Fail to delete "+ type +" type.";
	}
	// 17
	...
	// 18.5 1/5
	// <Conf.getAllAdminsInForum> <DELIM1> <forumName>
	private String handle_getAllAdminsInForum(String msg, Client client){
		String[] parsedMsg =  msg.split(Configuration.DELIMITER1);
		if (parsedMsg.length != 2){
			System.out.println("Got a getAllAdminsInForum, but not with 1 param");
			return Configuration.FAIL;
		}

		String forumName = parsedMsg[1].substring(0, parsedMsg[1].length()-1); 

		Vector<String> admins = this.serverHandler.getAllAdminsInForum(forumName);
		String ans = "";
	...
	// 18.5 2/5
	// <Conf.getMyPosts> <DELIM1> <userName> <DELIM1> forumName>
	private String handle_getMyPosts(String msg, Client client){
		String[] parsedMsg =  msg.split(Configuration.DELIMITER1);
		if (parsedMsg.length != 3){
			System.out.println("Got a getMyPosts, but not with 2 params");
			return Configuration.FAIL;
		}
		...
		Vector<String> topics = this.serverHandler.getMyPosts(userName, forumName);
		String ans = "";

		if (topics != null)
			for (String topic: topics)
				ans += topic + Configuration.DELIMITER1;
	...
	// 18.5 3/5
	// <Conf.getMyFreinds> <DELIM1> <userName> <DELIM1> <forumName>
	private String handle_getMyFreinds(String msg, Client client){
		String[] parsedMsg =  msg.split(Configuration.DELIMITER1);
		if (parsedMsg.length != 3){
			System.out.println("Got a getMyFreinds, but not with 2 params");
			return Configuration.FAIL;
		}
		...
		Vector<String> friends = this.serverHandler.getMyFreinds(userName, forumName);
		String ans = "";

		if (friends != null)
			for (String friend: friends)
				ans += friend + Configuration.DELIMITER1;
	...
	// 18.5 4/5
	// <Conf.getMyRequests> <DELIM1> <userName> <DELIM1> <forumName>
	private String handle_getMyRequests(String msg, Client client){
		String[] parsedMsg =  msg.split(Configuration.DELIMITER1);
		if (parsedMsg.length != 3){
			System.out.println("Got a getMyRequests, but not with 2 params");
			return Configuration.FAIL;
		}
		...
		Vector<String> friends = this.serverHandler.getMyRequests(userName, forumName);
		String ans = "";
	...
	// 18.5 5/5
	// <Conf.getJoinedMemberInForums>
	private String handle_getJoinedMemberInForums(String msg, Client client){
		String[] parsedMsg =  msg.split(Configuration.DELIMITER1);
		if (parsedMsg.length != 1){
			System.out.println("Got a getJoinedMemberInForums, but not with 1 param");
			return Configuration.FAIL;
		}

		Vector<String> members = this.serverHandler.getJoinedMemberInForums();
		String ans = "";

		if (members != null)
			for (String member: members)
				ans += member + Configuration.DELIMITER1;
	...
	private String handle_upgradeToModerator(String msg, Client client) {
		...
		if (ans)
			return Configuration.SUCCESS+ " " + Configuration.DELIMITER1+ " " +moderatorUserName+" is now a moderator in this subforum.";
	...
	private String handle_createSubForum(String msg, Client client) {
		...
		return Configuration.FAIL+" error : requested moderator is not qulified";
	}
	...
	//31
	// <Conf.getThreadContent> <DELIM1> <treadID> <DELIM1> <subForumName> <DELIM1> <forumName>
	public String handle_getThreadContent(String msg, Client client){
		String[] parsedMsg =  msg.split(Configuration.DELIMITER1);
		if (parsedMsg.length != 4){
			System.out.println("Got a getThreadContent, but not with 3 params");
			return Configuration.FAIL;
		}
		...
		String subForumName = parsedMsg[2];
		String forumName = parsedMsg[3].substring(0, parsedMsg[3].length()-1); 
		String ans = this.serverHandler.getThreadContent(treadID, subForumName, forumName);
	...
	// 35.5
	// <Conf.isItMyPost> <DELIM1> <userName> <DELIM1> forumName> <DELIM1> <subForum> <DELIM1> <postID>
	public String handle_isItMyPost(String msg, Client client){
		String[] parsedMsg =  msg.split(Configuration.DELIMITER1);
		if (parsedMsg.length != 5){
			System.out.println("Got a isItMyPost, but not with 4 params");
			return Configuration.FAIL;
		}
		...
		String forumName = parsedMsg[2];
		String subForum = parsedMsg[3];
		String treadID = parsedMsg[4].substring(0, parsedMsg[4].length()-1);

		boolean ans = this.serverHandler.isItMyPost(userName, forumName, subForum, treadID);
		if (ans)
			return Configuration.SUCCESS;
		return Configuration.FAIL;
	}
	...
	// 39.5
	// <Conf.isItMyResponse> <DELIM1> <userName> <DELIM1> <forumName> <DELIM1> <subForum> <DELIM1> <postID> <DELIM1> <responseID>
	public String handle_isItMyResponse(String msg, Client client){
		String[] parsedMsg =  msg.split(Configuration.DELIMITER1);
		if (parsedMsg.length != 6){
			System.out.println("Got a isItMyResponse, but not with 5 params");
			return Configuration.FAIL;
		}
		...
		String forumName = parsedMsg[2];
		String subForum = parsedMsg[3];
		String postID = parsedMsg[4];
		String responseID = parsedMsg[5].substring(0, parsedMsg[6].length()-1);

		boolean ans = this.serverHandler.isItMyResponse(userName, forumName, subForum, postID, responseID);
		if (ans)
			return Configuration.SUCCESS;
		return Configuration.FAIL;
	...
	// 43
	// <Conf.responseToFreindRequest> <DELIM1> <forumName> <DELIM1> <userName> <DELIM1> <userNameResponser> <DELIM1> <response>
		private String handle_responseToFreindRequest(String msg, Client client) {
			String[] parsedMsg =  msg.split(Configuration.DELIMITER1);
			if (parsedMsg.length != 5){
				System.out.println("Got a responseToFreindRequest, but not with 4 params");
				return Configuration.FAIL;
			}

			String forumName = parsedMsg[1];
			String userName = parsedMsg[2];
			String userNameResponser = parsedMsg[3];
			String response = parsedMsg[4].substring(0, parsedMsg[4].length()-1); 

			boolean ans = this.serverHandler.responseToFreindRequest(forumName, userName, userNameResponser, response);
			if (ans)
				return Configuration.SUCCESS;
			return Configuration.FAIL;
		}
	...
	//47
	// <Conf.getAllModerators> <DELIM1> <forumName> <DELIM1> <subForumName>
	public String handle_getAllModerators(String msg, Client client){
		String[] parsedMsg =  msg.split(Configuration.DELIMITER1);
		if (parsedMsg.length != 3){
			System.out.println("Got a getAllModerators, but not with 2 params");
			return Configuration.FAIL;
		}

		String forumName = parsedMsg[1]; 
		String subForumName = parsedMsg[2].substring(0, parsedMsg[2].length()-1);
		Vector<String> moderators = this.serverHandler.getAllModerators(forumName, subForumName);
		String ans = "";
	...
	// <Conf.exit> 
		public String handle_exit(String msg, Client client){
			this.serverHandler.exit();
			return "";
		}

		// <Conf.getNotifications> <DELIM1> <userName>
		private String handle_getNotifications(String msg, Client client) {
			
			String[] parsedMsg =  msg.split(Configuration.DELIMITER1);
			if (parsedMsg.length != 3){
				System.out.println("Got a getNotifications, but not with 2 param");
				return Configuration.FAIL;
			}
			...
			Vector<String> notifics = this.serverHandler.getNotifications(userName,forumName);
			String ans = "";
			if (notifics != null)
				for (String notific : notifics)
					ans += notific + Configuration.DELIMITER1;
