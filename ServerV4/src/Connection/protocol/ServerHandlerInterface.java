...
public interface ServerHandlerInterface {
    ...
    //separated by delim1
    public String getMyPosts(String userName, String forumName);

	// 18.5 3\5
    //return all the freinds of userName separated by delim1
    public String getMyFreinds(String userName, String forumName);
    
    // 18.5 4\5  
    //return all freind request sent to userName, separated by delim1
    public String getMyRequests(String userName, String forumName);
    
    // 18.5 5\5
    //return all jointed members in forums, separated by delim1
    public String getJoinedMemberInForums();
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	////////////// SUBFORUM //////////////////////////////////////////////////////////////////////////////////////////////////////////
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
