package ListenerServer.protocol.channels;
import java.io.IOException;
import java.nio.ByteBuffer;
import java.util.Vector;

import ListenerServer.protocol.Client;


/**
 * This class represent a channel
 */
public class SubForumChannel {
	 ...
	 */
	public SubForumChannel(Client client , String channelName){
