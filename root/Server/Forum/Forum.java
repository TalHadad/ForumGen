...
public class Forum {
	...
	public void addAdmin(String member){admins.add(member);}
	public String getName() {return name;}
	public void setName(String name) {this.name = name;}
	public Vector<SubForum> getSubForums() {return subForums;}
	...
	public String regiserToForum(String userName, String userPassword, String eMail,QuestionAnswerPair questionAnswerPair){
	...
	private SubForum getSubForum(String subject) {
	...
	//UC 16
	public String deleteSubforum(String subject){
